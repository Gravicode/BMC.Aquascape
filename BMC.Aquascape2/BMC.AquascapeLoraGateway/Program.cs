...
namespace BMC.AquascapeLoraGateway
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Init Lora Gateway for Aquascape");
            Console.WriteLine("Start receiving UDP from Lora gateway..");
        ...
        static void Loop()
        {
            ...
            while (true)
            {
                ...
                if (obj != null)
                {
                    ...
                    var sensorValue = new PowerBIData() { LimitSwitch1= deviceData.LimitSwitch1?1:0, LimitSwitch2 = deviceData.LimitSwitch2?1:0, Relay1 = deviceData.Relay1?1:0, Relay2=deviceData.Relay2?1:0,
    ...
    public class PowerBIData
    {
        ...
        public int LimitSwitch1 { get; set; }
        public int LimitSwitch2 { get; set; }
    }
}
